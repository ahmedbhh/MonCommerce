...
public class BonentreeProduit implements Serializable {
    ...
    @JoinColumn(name = "IDBonEntree", referencedColumnName = "IDBonEntree", nullable = false, insertable = false, updatable = false)
    ...
    public String toString() {
        return "moncommerce.domain.model.BonentreeProduit[ bonentreeProduitPK=" + bonentreeProduitPK + " ]";
    }
