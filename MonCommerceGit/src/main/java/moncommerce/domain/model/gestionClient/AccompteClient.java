...
public class AccompteClient implements Serializable {
    ...
    @Column(name = "ID_Accompte_Client")
    ...
    @OneToMany(mappedBy = "iDAccompteClient")
    ...
    public String toString() {
        return "moncommerce.domain.model.test.AccompteClient[ iDAccompteClient=" + iDAccompteClient + " ]";
    }
