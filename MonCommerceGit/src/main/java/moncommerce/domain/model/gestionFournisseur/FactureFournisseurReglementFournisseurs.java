...
public class FactureFournisseurReglementFournisseurs implements Serializable {
    ...
    @JoinColumn(name = "ID_Reglement_fournisseurs", referencedColumnName = "ID_Reglement_fournisseurs", insertable = false, updatable = false)
    @ManyToOne(optional = false)
    ...
    public String toString() {
        return "moncommerce.domain.model.test.FactureFournisseurReglementFournisseurs[ factureFournisseurReglementFournisseursPK=" + factureFournisseurReglementFournisseursPK + " ]";
    }
