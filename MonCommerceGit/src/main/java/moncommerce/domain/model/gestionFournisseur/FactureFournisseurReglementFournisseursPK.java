...
public class FactureFournisseurReglementFournisseursPK implements Serializable {
    ...
    public String toString() {
        return "moncommerce.domain.model.test.FactureFournisseurReglementFournisseursPK[ iDReglementfournisseurs=" + iDReglementfournisseurs + ", iDFactureFournisseur=" + iDFactureFournisseur + " ]";
    }
