...
@NamedQueries({
    ...
    @NamedQuery(name = "FactureClientProduit.findByIDFactureClients", query = "SELECT f FROM FactureClientProduit f WHERE f.factureClientProduitPK.iDFactureClients = :iDFactureClients"),
...
public class FactureClientProduit implements Serializable {
    ...
    public FactureClientProduit(long iDFactureClients, long idProduit) {
        this.factureClientProduitPK = new FactureClientProduitPK(iDFactureClients, idProduit);
    }
    ...
    public String toString() {
        return "moncommerce.domain.model.test.FactureClientProduit[ factureClientProduitPK=" + factureClientProduitPK + " ]";
    }
