...
public class ProduitCodeTarif implements Serializable {
    ...
    @JoinColumn(name = "ID_Code_tarif", referencedColumnName = "ID_Code_tarif", insertable = false, updatable = false)
    ...
    public String toString() {
        return "moncommerce.domain.model.test.ProduitCodeTarif[ produitCodeTarifPK=" + produitCodeTarifPK + " ]";
    }
