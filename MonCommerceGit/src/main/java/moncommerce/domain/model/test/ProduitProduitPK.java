...
public class ProduitProduitPK implements Serializable {
    ...
    @NotNull
    @Column(name = "ID_Produit_Composant")
    private long iDProduitComposant;
    @Basic(optional = false)
    @NotNull
    @Column(name = "ID_Produit_Composee")
    ...
    public String toString() {
        return "moncommerce.domain.model.test.ProduitProduitPK[ iDProduitComposant=" + iDProduitComposant + ", iDProduitComposee=" + iDProduitComposee + " ]";
    }
