...
public class FamilleFournisseur implements Serializable {
    ...
    @Column(name = "ID_Famille_Fournisseur")
    ...
    @OneToMany(mappedBy = "iDFamilleFournisseur")
    ...
    public String toString() {
        return "moncommerce.domain.model.test.FamilleFournisseur[ iDFamilleFournisseur=" + iDFamilleFournisseur + " ]";
    }
