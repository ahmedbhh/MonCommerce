...
package moncommerce.domain.model.client;
...
@NamedQueries({
    ...
    @NamedQuery(name = "Client.findByIDFamilleclient", query = "SELECT c FROM Client c WHERE c.iDFamilleclient = :iDFamilleclient"),
...
public class Client implements Serializable {
    ...
    @Column(name = "ID_Famille_client")
    private BigInteger iDFamilleclient;
    @Basic(optional = false)
    @NotNull
    ...
    public BigInteger getIDFamilleclient() {
        return iDFamilleclient;
    }

    public void setIDFamilleclient(BigInteger iDFamilleclient) {
