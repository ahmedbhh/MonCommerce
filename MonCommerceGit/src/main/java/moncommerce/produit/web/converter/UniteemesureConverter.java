...
public class UniteemesureConverter implements Converter {
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof Uniteemesure) {
            Uniteemesure o = (Uniteemesure) object;
            return getStringKey(o.getIDUniteeMesure());
        } else {
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), Uniteemesure.class.getName()});
            return null;
        }
    }
