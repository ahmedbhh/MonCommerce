...
public class ModeDeReglementConverter implements Converter {
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof ModeDeReglement) {
            ModeDeReglement o = (ModeDeReglement) object;
            return getStringKey(o.getIDModedereglement());
        } else {
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), ModeDeReglement.class.getName()});
            return null;
        }
    }
