...
public class FactureClientsConverter implements Converter {
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof FactureClients) {
            FactureClients o = (FactureClients) object;
            return getStringKey(o.getIDFactureClients());
        } else {
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), FactureClients.class.getName()});
            return null;
        }
    }
